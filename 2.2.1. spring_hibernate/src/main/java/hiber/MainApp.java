...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      userService.add(new User("User1", "Lastname1", "user1@mail.ru", new Car("Kia Rio", 1)));
      ...
      User userrr = userService.getUserByCarModelAndSeries("Kia Rio", 1);
      System.out.println("Это машина " + userrr.getFirstName());
